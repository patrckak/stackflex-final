(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/08b5e_@auth_core_93ce20._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$jwt$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@auth/core/jwt.js [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@auth/core/node_modules/oauth4webapi/build/index.js [middleware] (ecmascript)");
;
;
;
...
const pkce = {
    /** Creates a PKCE code challenge and verifier pair. The verifier in stored in the cookie. */ async create (options) {
        const code_verifier = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.generateRandomCodeVerifier();
        const value = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.calculatePKCECodeChallenge(code_verifier);
...
const state = {
    /** Creates a state cookie with an optionally encoded body. */ async create (options, origin) {
        ...
        const payload = {
            origin,
            random: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.generateRandomState()
        };
...
const nonce = {
    async create (options) {
        ...
        const value = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.generateRandomNonce();
...
async function handleOAuth(params, cookies, options) {
    ...
    if ((!token?.url || token.url.host === "authjs.dev") && (!userinfo?.url || userinfo.url.host === "authjs.dev")) {
        ...
        const discoveryResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.discoveryRequest(issuer, {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.allowInsecureRequests]: true,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.customFetch]: provider[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$symbols$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["customFetch"]]
        });
        as = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.processDiscoveryResponse(issuer, discoveryResponse);
    ...
    switch(client.token_endpoint_auth_method){
        ...
        case "client_secret_post":
            clientAuth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.ClientSecretPost(provider.clientSecret);
            break;
        case "client_secret_jwt":
            clientAuth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.ClientSecretJwt(provider.clientSecret);
            break;
        case "private_key_jwt":
            clientAuth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.PrivateKeyJwt(provider.token.clientPrivateKey, {
                // TODO: review in the next breaking change
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.modifyAssertion] (_header, payload) {
                    payload.aud = [
                        as.issuer,
                        as.token_endpoint
                    ];
            ...
            break;
        case "none":
            clientAuth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.None();
            break;
        default:
    ...
    let codeGrantParams;
    try {
        codeGrantParams = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.validateAuthResponse(as, client, new URLSearchParams(params), provider.checks.includes("state") ? state : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.skipStateCheck);
    } catch (err) {
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.AuthorizationResponseError) {
            const cause = {
    ...
    let codeGrantResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.authorizationCodeGrantRequest(as, client, clientAuth, codeGrantParams, redirect_uri, codeVerifier ?? "decoy", {
        // TODO: move away from allowing insecure HTTP requests
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.allowInsecureRequests]: true,
        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.customFetch]: (...args)=>{
    ...
    const processedCodeResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.processAuthorizationCodeResponse(as, client, codeGrantResponse, {
    ...
    if (requireIdToken) {
        const idTokenClaims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.getValidatedIdTokenClaims(processedCodeResponse);
        ...
        if (provider.idToken === false) {
            const userinfoResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.userInfoRequest(as, client, processedCodeResponse.access_token, {
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.customFetch]: provider[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$symbols$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["customFetch"]],
                // TODO: move away from allowing insecure HTTP requests
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.allowInsecureRequests]: true
            });
            profile = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.processUserInfoResponse(as, client, idTokenClaims.sub, userinfoResponse);
        }
    } else {
        if (userinfo?.request) {
...
async function getAuthorizationUrl(query, options) {
    ...
    if (!url || url.host === "authjs.dev") {
        ...
        const as = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__.processDiscoveryResponse(issuer, discoveryResponse);
...
//# sourceMappingURL=08b5e_%40auth_core_93ce20._.js.map